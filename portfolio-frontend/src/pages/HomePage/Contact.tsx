...
const Contact: React.FC = () => {
  ...
  return (
    <div
      id="contact-section"
      className="relative flex flex-col justify-center items-center px-6 py-16 bg-gradient-to-tr from-gray-100 via-gray-200 to-gray-300 dark:from-gray-800 dark:via-gray-900 dark:to-black text-gray-800 dark:text-gray-100"
    >
      {/* Light Beam */}
      <motion.div
      ...
      <AnimatedSection>
        <div className="text-center mt-12 mb-12">
          ...
          <p className="mt-4 text-lg md:text-xl leading-relaxed text-gray-600 dark:text-gray-300">
            Whether you have a question, a suggestion, or you just want to say
